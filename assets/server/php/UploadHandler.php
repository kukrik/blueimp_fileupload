...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/bigs/',
            'upload_url' => $this->get_full_url().'/files/bigs/',
            ...
            //'accept_file_types' => '/(\.|\/)(gif|jpe?g|png|pdf|doc|docx|xls|xlsx|zip|asice)$/i',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/bigs//thumbs/',
                    //'upload_url' => $this->get_full_url().'/bigs/thumbs/',
